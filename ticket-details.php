            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="right-content">
                        ...
                        <ul>
                            <li><i class="fa fa-clock-o"></i> Thursday, Oct 17, 2024 - 18:00 to 22:00</li>
                            <li><i class="fa fa-map-marker"></i>Mahalaxmi Race Course, Mumbai</li>
                        </ul>
                        <form id="ticketForm" action="confirm-purchase.php" method="POST">
                            <input type="hidden" name="event_name" value="Sunny Hill Festival">
                            <input type="hidden" name="event_date" value="Thursday, Oct 17, 2024 - 18:00 to 22:00">
