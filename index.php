            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="event-item">
                        ...
                        <div class="down-content">
                            <a href="event-details.php"><h4>Radio City Musical Hall</h4></a>
                            <ul>
                ...
                <div class="col-lg-4">
                    <div class="event-item">
                        ...
                        <div class="down-content">
                            <a href="event-details.php"><h4>Madison Square Garden</h4></a>
                            <ul>
                ...
                <div class="col-lg-4">
                    <div class="event-item">
                        ...
                        <div class="down-content">
                            <a href="event-details.php"><h4>Royce Hall</h4></a>
                            <ul>
