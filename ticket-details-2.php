            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="left-image">
                        <img src="assets/images/ticket-details-2.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Wonderful Festival</h4>
                        <span>150 Tickets still available</span>
                        <ul>
                            <li><i class="fa fa-clock-o"></i> Sunday, Oct 20, 2024 - 05:00 PM to 10:00 PM</li>
                            <li><i class="fa fa-map-marker"></i>Mahalaxmi Race Course, Mumbai</li>
                        </ul>
                        <form id="ticketForm" action="confirm-purchase.php" method="POST">
                            <input type="hidden" name="event_name" value="Wonderful Festival">
                            <input type="hidden" name="event_date" value="Sunday, Oct 20, 2024 - 05:00 PM to 10:00 PM">
                            <input type="hidden" name="venue" value="Mahalaxmi Race Course, Mumbai">
                        ...
                        <div class="total">
                            <h4 id="totalPrice">Total: $25.00</h4>
