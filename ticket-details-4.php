            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="left-image">
                        <img src="assets/images/ticket-details-4.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Water Splash Festival</h4>
                        <span>260 Tickets still available</span>
                        <ul>
                        ...
                        <form id="ticketForm" action="confirm-purchase.php" method="POST">
                            <input type="hidden" name="event_name" value="Water Splash Festival">
                            <input type="hidden" name="event_date" value="Thursday 07:00 PM to 11:00 PM">
                            <input type="hidden" name="venue" value="Jio World Garden, Mumbai">
                            <input type="hidden" name="ticket_price" value="65">
                        ...
                        <div class="total">
                            <h4 id="totalPrice">Total: $65.00</h4>
